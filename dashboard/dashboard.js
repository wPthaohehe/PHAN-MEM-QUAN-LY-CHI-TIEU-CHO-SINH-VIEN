(function () {
  ...
  function draw(summary, balance, all, cats) {
    let html =
    ...
    if (all.length === 0) {
      html += '<div class="card welcome" style="margin-bottom:16px"><div class="empty">' +
        ...
        '<p>Bạn chưa có giao dịch nào. Hãy ghi lại khoản thu/chi đầu tiên, hoặc nạp dữ liệu mẫu để dùng thử.</p>' +
    ...
    /* ĐÃ GỠ: Charts.doughnut(#donutBox) và Charts.bars(#barsBox).
       Không còn thẻ DOM tương ứng nên console sẽ không báo lỗi. */
